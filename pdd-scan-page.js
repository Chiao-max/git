// 拼多多 - 扫码取件页（m.pinduoduo.net/mdkd/package）去广告
// 1) 把页面里引用的原生 chunk 换成仓库内的补丁版 chunk（去掉商品推荐/弹窗逻辑）
// 2) 删掉 index_gif-container 容器
// 3) 裁剪 __NEXT_DATA__.props.pageProps.serverData，只保留 fastBindCMobilePreCheck / queryStationPackageInfo
// 转换自 Loon 插件 PinDuoDuo_remove_ads.lpx（作者：ZenmoFeiShi、可莉）
/*
...
const newChunk = "https://raw.githubusercontent.com/Chiao-max/git/master/pdd-scan-chunk.js";
